...
if (fs.existsSync('/Users/jgauci/keystore.pem')) {
  console.log("Loading credentials...");
  var certificate  = fs.readFileSync('/Users/jgauci/tidalwave.apple.com.chain.pem', 'utf8');
  var privateKey = fs.readFileSync('/Users/jgauci/keystore.pem', 'utf8');
  var passphrase = "4owutD9k";
              
  credentials = {key: privateKey, cert: certificate, passphrase:passphrase};
} else {
...
db.once('open', function callback () {
  ...
  var server = exports.server = https.createServer(credentials,app).listen(app.get('port'),
  function() {
